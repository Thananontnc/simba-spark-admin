...
export default async function CoursesPage() {
  const [rawSections, courses, timeframes, instructors, students, enrollments, bookings, sectionInstructors] = await Promise.all([
    sql`
    ...
    sql`SELECT id, label, start_date::text, end_date::text FROM timeframes ORDER BY start_date`,
